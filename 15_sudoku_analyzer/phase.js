...
updateInfo(){
	...
	const controllerStyle = ((this.graph||this.phase=="User Solving")?"inline-block":"none");
	slider.style.display = controllerStyle;
	rightA.style.display = controllerStyle;
	leftA.style.display = controllerStyle;
}
draw(){
